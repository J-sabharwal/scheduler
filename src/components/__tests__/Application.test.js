...
describe("Application", () => {
  ...
  it("loads data, books an interview and reduces the spots for the first day by 1", async() => {
 ...
 it("loads data, cancels an interview and increases the spots remaining for Monday by 1", async () => {
  ...
  // 7. Wait until the element with the text Arthur Cohen is displayed.
  await waitForElement(() => queryByText(appointment, "Arthur Cohen"));
